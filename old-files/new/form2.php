...
<div class="container">
    ...
    <div class="form-area"> <span id="success_msg"></span>
        ...
        <div class="form-group">
                  <label>Address</label>
                  <textarea class="form-control" type="textarea" id="address" placeholder="Additional Services" maxlength="140" rows="3" name="address"></textarea>
                  <span id="address_err" style="color:#F00;"></span> </div>
        <div class="form-group">
...
<script>
 ...
 $.ajax
   ({
    ...
    url: "http://ap.digital/digital/enquiry2.php",
	 type: "POST",
